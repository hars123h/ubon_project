...
//[#2e9afe]
    return (
        <div className=' bg-red-500 pb-3 sm:h-[1000px] md:h-screen h-screen'>
...
{/* [#bfdbf5] */}
            <div className='flex flex-wrap items-center py-2 px-4 bg-red-400 border-b border-white'>
...
{/* [#2e9afe] */}
                <button className='bg-red-500 shadow-lg w-20 text-center  ml-3 text-white rounded-full p-2.5'>Search</button>
            </div>
{/* [#bce4ed] */}
            <div className='records w-full flex bg-red-400 items-center'>
